...
class PyMsCognitiveSuggestions(PyMsCognitiveSearch):
    COGNITIVE_SUGGESTIONS_BASE = 'https://api.cognitive.microsoft.com/bing/{}/suggestions'.format(
    ...
    def _search(self, limit, format):
        ...
        packaged_results = [SuggestResult(single_result_json) for single_result_json in
                            json_results.get("suggestionGroups", [])[0].get("searchSuggestions", [])]
